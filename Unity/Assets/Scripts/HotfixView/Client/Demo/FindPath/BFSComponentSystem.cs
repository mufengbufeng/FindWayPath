...
namespace ET.Client
{
    [EntitySystemOf(typeof(BFSComponent))]
    [FriendOfAttribute(typeof(ET.Client.BFSComponent))]
    [FriendOfAttribute(typeof(ET.Client.FindPathDataComponent))]
    public static partial class BFSComponentSystem
    {
        [EntitySystem]
        private static void Awake(this ET.Client.BFSComponent self)
        {
        ...
        /// 初始化网格大小
        /// </summary>
        public static void InitGrid(this BFSComponent self, int width, int height)
        {
            self.Width = width;
            self.Height = height;
        }
        ...
        public static bool FindPath(this BFSComponent self, CubeState[,] cubeStatesArr, GridPosition startPos, GridPosition endPos)
        {
            ...
            Log.Info($"开始BFS寻路：从 {startPos} 到 {endPos}");
        ...
        /// 检查位置是否有效
        /// </summary>
        private static bool IsValidPosition(this BFSComponent self, GridPosition pos)
        {
        ...
        /// 构建路径结果
        /// </summary>
        private static void BuildPath(this BFSComponent self, Dictionary<GridPosition, PathNode> nodeMap, GridPosition startPos, GridPosition endPos)
        {
        ...
        /// 获取路径结果
        /// </summary>
        public static List<GridPosition> GetPathResult(this BFSComponent self)
        {
        ...
        /// 清除路径结果
        /// </summary>
        public static void ClearPath(this BFSComponent self)
        {
            self.PathResult.Clear();
            self.IsPathfinding = false;
        ...
        /// 动画寻路算法
        /// </summary>
        public static async ETTask<bool> AnimatedFindPath(this BFSComponent self, CubeState[,] cubeStatesArr, GridPosition startPos, GridPosition endPos, OperaComponent operaComponent)
        {
            ...
            try
            {
                ...
                Log.Info($"开始动画BFS寻路：从 {startPos} 到 {endPos}");
        ...
        /// 动画显示最终路径
        /// </summary>
        private static async ETTask AnimatePathDisplay(this BFSComponent self, OperaComponent operaComponent)
        {
            var findPathDataComponent = operaComponent.Scene().GetComponent<FindPathDataComponent>();
        ...
        /// 设置动画速度
        /// </summary>
        public static void SetAnimSpeed(this BFSComponent self, int speed)
        {
        ...
        /// 停止动画寻路
        /// </summary>
        public static void StopAnimPathfinding(this BFSComponent self)
        {
            if (self.AnimCancellationToken != null)
            {
                self.AnimCancellationToken.Cancel();
